...
test("should throw error when url is not passed and cb is passed it", t => {
  t.throws(() => npm.load(undefined, () => {}), {
    message: "options.uri is a required argument"
  });
});

test.cb("should return download stat when valid variables are passed it", t => {
  const expectValues = {
    downloads: 197,
    start: "2020-01-01",
    end: "2020-08-01",
